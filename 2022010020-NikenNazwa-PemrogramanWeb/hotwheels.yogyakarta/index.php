...
<div class="container">
		...
		<h4 class="text-center" style="font-family: arial; padding-top: 10px; padding-bottom: 10px; font-style: italic; line-height: 29px; border-top: 2px solid #e7241d; border-bottom: 2px solid #e7241d;">Hotwheels Yogyakarta adalah salah satu toko yang menjual diecast dalam bisnis online di Indonesia. Produk kami berkulitas, bagus, dan terjangkau oleh semua orang.</h4>


	<h2 style=" width: 100%; border-bottom: 4px solid #e7241d; margin-top: 80px;"><b>Produk Kami</b></h2>
